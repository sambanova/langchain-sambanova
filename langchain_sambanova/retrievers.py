...
class SambaNovaRetriever(BaseRetriever):
    ...
    Setup:
        Install ``langchain-sambanova`` and set environment variable
        ``SAMBANOVA_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-sambanova import SambaNovaRetriever

            retriever = SambaNovaRetriever(
                # ...
            )
