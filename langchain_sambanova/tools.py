...
class SambaNovaToolInput(BaseModel):
    """Input schema for SambaNova tool.
...
class SambaNovaTool(BaseTool):  # type: ignore[override]
    """SambaNova tool.
    ...
    args_schema: Type[BaseModel] = SambaNovaToolInput
