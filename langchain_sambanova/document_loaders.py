...
class SambaNovaLoader(BaseLoader):
    ...
    """
    SambaNova document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import SambaNovaLoader

            loader = SambaNovaLoader(
                # required params = ...
                # other params = ...
            )
