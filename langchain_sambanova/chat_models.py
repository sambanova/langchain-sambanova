...
class ChatSambaNova(BaseChatModel):
    ...
    """SambaNova chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-sambanova`` and set environment variable ``SAMBANOVA_API_KEY``.
    ...
    Key init args — completion params:
        model: str
            Name of SambaNova model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            SambaNova API key. If not passed in will be read from env var SAMBANOVA_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatSambaNova.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatSambaNova.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatSambaNova supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatSambaNova supports async generation. Otherwise delete.
